const arr = {
    id8: `
        <div style="padding-bottom: 12px;">
            ...
            <p><span style="color: #cccccc; font-size: 10pt;"> 步数：25，采样器：euler 或者 dpm，图像放大：1.1-2，提示强度：3|5-7</span></p>
        </div>
        `
    ,
    id7: `
        <div style="padding-bottom: 12px;">
            <p><span style="font-size: 10pt; color: #cccccc;">这是在具有未来派科幻主题的高质量3D图像上训练的微调Stable Diffusion 2.0模型。</span></p>
            ...
            <blockquote>
            <p><span style="font-size: 10pt; color: #cccccc;">关键词：future style [subject]</span></p>
            <p><span style="font-size: 10pt; color: #cccccc;">排除项：duplicate heads bad anatomy</span></p>
            <p><span style="font-size: 10pt; color: #cccccc;">推理步数： 20， 采样器： euler_a， 宽高： 512x704，提示强度：7</span></p>
            </blockquote>
            ...
            <blockquote>
            <p><span style="font-size: 10pt; color: #cccccc;">关键词：future style city market street level at night</span></p>
            <p><span style="font-size: 10pt; color: #cccccc;">排除项：blurry fog soft</span></p>
            <p><span style="font-size: 10pt; color: #cccccc;">推理步数： 20， 采样器： euler_a， 宽高： 1024x576，提示强度：7</span></p>
            </blockquote>
    ...
    id6: `
        <div style="padding-bottom: 12px;">
            <p><span style="font-size: 10pt; color: #cccccc;"><strong>Modern Disney </strong>是一个基于Stable Diffusion 1.5的开源模型。</span></p>
            ...
            <p><span style="color: #cccccc; font-size: 10pt;">步数： 50， 采样器： euler_a， 种子： 3940025417， 宽高： 512x768，提示强度：7</span></p>
            ...
            <p><span style="color: #cccccc; font-size: 10pt;"> 步数：50，采样器：euler_a，种子：1355059992，宽高：512x512，提示强度：7</span></p>
        </div>
        `
    ,
    id3: `
